...
**[下载 Windows x64 完整包 · v0.3.4](https://github.com/turnsolesama/portfolio/releases/download/yingxu-v0.3.4/YingXu-v0.3.4-Windows-x64.zip)**
...
- 文件直接打开：从 Windows“打开方式”或“预览本地文件”只读预览，单实例接收文件；注册候选可撤销，不抢默认应用。
