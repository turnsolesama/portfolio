...
**[下载 Windows x64 程序包 · v0.2.2](https://raw.githubusercontent.com/turnsolesama/portfolio/main/yingxu/releases/YingXu-v0.2.2-Windows-x64.zip)**
...
支持拖入文件、引用已有目录、多选移动和两种改名。从卡片缩略图或列表行按住拖到左侧分类、文件夹或根目录即可移动；v0.2.2 修复图片拖动误触发导入副本的问题。项目内文件移动时同步调整实际路径；外部引用保留源位置。卡片或列表行右键打开所在文件夹，项目和分类也有对应的目录入口。
...
- 桌面版提供“拖出文件”手柄，向支持接收文件的应用传递实际路径。
