...
**[下载 Windows x64 程序包 · v0.2.1](https://raw.githubusercontent.com/turnsolesama/portfolio/main/yingxu/releases/YingXu-v0.2.1-Windows-x64.zip)**
...
支持拖入文件、引用已有目录、多选移动和两种改名。项目内文件移动时同步调整实际路径；外部引用保留源位置。卡片或列表行右键打开所在文件夹，项目和分类也有对应的目录入口。
