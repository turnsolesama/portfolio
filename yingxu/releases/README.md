...
当前版本为 **0.2.2**，使用 MIT 许可证。桌面壳包含的微软 WebView2 SDK 组件遵循包内 `desktop/WebView2-LICENSE.txt`。

下载 [YingXu-v0.2.2-Windows-x64.zip](https://raw.githubusercontent.com/turnsolesama/portfolio/main/yingxu/releases/YingXu-v0.2.2-Windows-x64.zip)，完整解压后双击 `YingXu.exe`。**ZIP 包含应用与源码，不包含 Python 运行环境。** 需要 Windows 10/11 x64、Python 3.11+、.NET Framework 4.8+ 与 WebView2 Runtime；Pillow 和 FFmpeg 为缩略图可选依赖。

[SHA-256 清单](YingXu-v0.2.2-SHA256.txt) · [包大小与摘要](YingXu-v0.2.2-manifest.json) · [发布验证记录](YingXu-v0.2.2-verification.json) · [运行条件与配置](../RUNNING.md) · [功能介绍](../README.md)
