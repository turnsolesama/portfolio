...
$files=@(
    'ProxySwitch.ps1','ProxyBackend.ps1','ProxyWindow.ps1','AppRouting.ps1','AppRouter.cjs','Preferences.ps1','ProxyDiscovery.ps1','ProcessInventory.ps1',
    ...
    'Build-Release.ps1','Test-Compatibility.ps1','Test-AutomaticDiscovery.ps1','Test-AutomaticDiscoveryUI.ps1','Test-SwitchInteraction.ps1','Test-PassiveLifecycle.ps1','Test-DiscoveryUI.ps1','README.md','CHANGELOG.md','LICENSE','THIRD_PARTY_NOTICES.md','AGENTS.md','.gitignore','.gitattributes',
...
$archive=Join-Path $destinationPath 'ProxySwitch-v3.0.3-Windows-Source.zip'
