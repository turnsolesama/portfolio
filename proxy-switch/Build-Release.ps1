...
$files=@(
    'ProxySwitch.ps1','ProxyBackend.ps1','ProxyWindow.ps1','AppRouting.ps1','AppRouter.cjs','Preferences.ps1',
    'config.defaults.json','启动代理切换.cmd','Install-Shortcut.ps1','Test-All.ps1','Test-ProxySwitch.ps1','Test-AppRouter.cjs','Test-Preferences.ps1',
...
$archive=Join-Path $destinationPath 'ProxySwitch-v3.0.0-Windows-Source.zip'
