...
$files=@(
    'Test-MigrationTransaction.ps1',
    'ProxySwitch.ps1','ProxyBackend.ps1','ProgramIdentity.ps1','ManagedRouting.ps1','ProgramFamilyTracking.ps1','ApplicationObservation.ps1','RuleMaintenance.ps1','ProxyWindow.ps1','AppRouting.ps1','AppRouter.cjs','IndependentRouter.cjs','RoutePolicy.cjs','GatewayPortOwnership.ps1','IndependentGateway.ps1','GatewayWatchdog.ps1','GatewayLock.ps1','Preferences.ps1','ProxyDiscovery.ps1','ProcessInventory.ps1','ProgramLaunch.ps1','Storage.ps1','RuntimeSupport.ps1','Prepare-Runtime.ps1','runtime.lock.json','Test-RuntimeBundle.ps1','Test-RuntimePerformance.cjs','Test-StatusSnapshot.ps1','DesktopBranding.cs','FlowTheme.cs',
    'config.defaults.json','启动代理切换.cmd','Install-Shortcut.ps1','Test-All.ps1','Test-GatewayLock.cjs','Test-WindowInstance.ps1','Test-Lifecycle.cjs','Test-LifecycleProtection.ps1','Test-TrayLifecycle.ps1','Test-SupervisorRecovery.ps1','Test-IndependentRouter.cjs','Test-IndependentIntegration.cjs','Test-ExitRecovery.ps1','Test-Watchdog.ps1','Test-GatewayControl.ps1','Test-GatewayIntegration.cjs','Test-ProxySwitch.ps1','Test-AppRouter.cjs','Test-Preferences.ps1','Test-ProxyDiscovery.ps1',
    ...
    'Test-ProgramFamilyTracking.ps1','Test-ManagedRouting.ps1','Test-ManagedObservation.ps1','Test-RoutingWorkbenchUI.ps1','Test-LaunchDispatch.ps1','Test-ManagedSwitchChain.ps1','Test-ProgramIngressIntegration.cjs','Test-RoutePolicy.cjs','Test-ManagedRemoval.ps1','CORE_REBUILD.md','Test-ManagedLaunchEvidence.ps1','Test-OfflineDetach.cjs','Test-OfflineMigration.ps1','DESIGN.md','MAINTENANCE.md','ACCEPTANCE.md','TEST_REPORT.md','Test-ProgramIdentity.ps1','Test-ApplicationObservation.ps1','Test-RuleMaintenance.ps1','Test-ObservationUI.ps1','Test-WorkerOutcome.ps1','Test-EntryMaintenance.ps1','Test-SwitchChain.ps1','Test-VisualTheme.ps1','assets/FlowSwitch.ico','assets/FlowSwitch.png','assets/screenshot.png','assets/program-menu.png','assets/proxy-management.png',
...
$archive=Join-Path $destinationPath ('FlowSwitch-v'+$productVersion+'-Windows-Source.zip')
