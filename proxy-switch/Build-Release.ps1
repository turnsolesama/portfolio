...
$files=@(
    'ProxySwitch.ps1','ProxyBackend.ps1','ProgramIdentity.ps1','ApplicationObservation.ps1','RuleMaintenance.ps1','ProxyWindow.ps1','AppRouting.ps1','AppRouter.cjs','IndependentRouter.cjs','IndependentGateway.ps1','GatewayWatchdog.ps1','Preferences.ps1','ProxyDiscovery.ps1','ProcessInventory.ps1','ProgramLaunch.ps1','Storage.ps1','RuntimeSupport.ps1','Prepare-Runtime.ps1','runtime.lock.json','Test-RuntimeBundle.ps1','Test-RuntimePerformance.cjs','Test-StatusSnapshot.ps1','DesktopBranding.cs','FlowTheme.cs',
    'config.defaults.json','启动代理切换.cmd','Install-Shortcut.ps1','Test-All.ps1','Test-WindowInstance.ps1','Test-Lifecycle.cjs','Test-LifecycleProtection.ps1','Test-TrayLifecycle.ps1','Test-SupervisorRecovery.ps1','Test-IndependentRouter.cjs','Test-IndependentIntegration.cjs','Test-ExitRecovery.ps1','Test-Watchdog.ps1','Test-GatewayControl.ps1','Test-GatewayIntegration.cjs','Test-ProxySwitch.ps1','Test-AppRouter.cjs','Test-Preferences.ps1','Test-ProxyDiscovery.ps1',
