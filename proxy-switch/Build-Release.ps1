...
$files=@(
    'ProxySwitch.ps1','ProxyBackend.ps1','ProgramIdentity.ps1','ApplicationObservation.ps1','RuleMaintenance.ps1','ProxyWindow.ps1','AppRouting.ps1','AppRouter.cjs','IndependentRouter.cjs','IndependentGateway.ps1','GatewayWatchdog.ps1','GatewayLock.ps1','Preferences.ps1','ProxyDiscovery.ps1','ProcessInventory.ps1','ProgramLaunch.ps1','Storage.ps1','RuntimeSupport.ps1','Prepare-Runtime.ps1','runtime.lock.json','Test-RuntimeBundle.ps1','Test-RuntimePerformance.cjs','Test-StatusSnapshot.ps1','DesktopBranding.cs','FlowTheme.cs',
    ...
    'DESIGN.md','ACCEPTANCE.md','TEST_REPORT.md','Test-ProgramIdentity.ps1','Test-ApplicationObservation.ps1','Test-RuleMaintenance.ps1','Test-ObservationUI.ps1','Test-WorkerOutcome.ps1','Test-VisualTheme.ps1','assets/FlowSwitch.ico','assets/FlowSwitch.png','assets/screenshot.png','assets/program-menu.png','assets/proxy-management.png',
