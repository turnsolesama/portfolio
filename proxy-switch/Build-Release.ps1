...
$files=@(
    'ProxySwitch.ps1','ProxyBackend.ps1','ProxyWindow.ps1','AppRouting.ps1','AppRouter.cjs','Preferences.ps1','ProxyDiscovery.ps1','ProcessInventory.ps1','ProgramLaunch.ps1','Storage.ps1','DesktopBranding.cs','FlowTheme.cs',
...
$archive=Join-Path $destinationPath 'FlowSwitch-v3.3.2-Windows-Source.zip'
