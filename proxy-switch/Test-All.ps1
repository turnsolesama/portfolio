...
foreach($name in @('Test-ProxySwitch.ps1','Test-Preferences.ps1','Test-ProxyDiscovery.ps1','Test-Compatibility.ps1','Test-AutomaticDiscovery.ps1','Test-ProgramLaunch.ps1','Test-Storage.ps1','Test-GatewayControl.ps1','Test-ExitRecovery.ps1','Test-Watchdog.ps1','Test-StatusSnapshot.ps1','Test-FailoverDisplay.ps1','Test-LifecycleProtection.ps1')){
