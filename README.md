...
| --- | --- | --- | --- |
| 写剧本、管分镜，按集数整理角色、场景和生成结果 | **[映序 YingXu](yingxu/)** | 0.2.1 | **[下载映序 · 525 KiB](https://raw.githubusercontent.com/turnsolesama/portfolio/main/yingxu/releases/YingXu-v0.2.1-Windows-x64.zip)** |
