...
| --- | --- | --- | --- |
| 写剧本、管分镜，按集数整理角色、场景和生成结果 | **[映序 YingXu](yingxu/)** | 0.3.5 | **[下载映序](https://github.com/turnsolesama/portfolio/releases/download/yingxu-v0.3.5/YingXu-v0.3.5-Windows-x64.zip)** |
...
这些 EXE 是桌面启动入口，需要保留完整程序包，并满足各自的运行条件。映序 0.3.5 与 FlowSwitch 3.5.1 完整包已自带主要运行组件；各软件请按自己的说明配置。各包不包含模型权重或代理服务。
