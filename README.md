...
3. AI Hub 双击 `AI Hub.exe`；Codex Switcher 双击 `Codex Switcher.exe`；ProxySwitch 双击 `ProxySwitch.exe`。

软件运行要求、历史版本和校验值分别放在各自文件夹中。AI Hub 和 Codex Switcher 的 EXE 需要本机 Python；ProxySwitch 程序包使用 Windows 自带 PowerShell 和 .NET Framework，源码包另行提供。
