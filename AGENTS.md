...
- Keep each application in its own folder: `yingxu/`, `ai-hub/`, `codex-switcher/`, and `proxy-switch/`. The repository README is a designed Chinese overview and directory; each application has its own detailed feature and usage page.
